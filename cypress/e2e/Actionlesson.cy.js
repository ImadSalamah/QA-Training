...
describe('Actions lesson', () => {
   ...
   beforeEach(() => {
    ...
    it('Type Command', () => {
        cy.get("[placeholder='Type your name']").clear().type("Imad")
        cy.get("[placeholder='Type your name']").clear().type("Imad",{delay:1000})
        cy.get("[name=input_0]").clear({force:true}).type("Imad",{force:true})
    });
